...
public class UpdateTodoFailTransformerImpl extends FailTransformerImpl {
    public UpdateTodoFailTransformerImpl(HttpStatusCode httpStatusCode, Exception exception) {
